...
export interface Gnosis_safe_l2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | 'VERSION'
...
export interface Gnosis_safe_l2 extends BaseContract {
  connect(runner?: ContractRunner | null): Gnosis_safe_l2;
  ...
  checkNSignatures: TypedContractMethod<
    [dataHash: BytesLike, data: BytesLike, signatures: BytesLike, requiredSignatures: BigNumberish],
    [void],
    'view'
  >;
